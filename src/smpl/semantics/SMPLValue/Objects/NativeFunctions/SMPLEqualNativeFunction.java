 ...
 * 
 */
public class SMPLEqualNativeFunction extends SMPLNativeProcedure {

    public SMPLEqualNativeFunction() {
	super(
	...
	final SMPLBoolean result = new SMPLBoolean(e1Obj.isEqualTo(e2Obj));
