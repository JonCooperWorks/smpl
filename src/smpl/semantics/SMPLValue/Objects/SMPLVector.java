 ...
 * 
 */
public class SMPLVector extends SMPLObject implements
	...
	public SMPLVector() {
		...
		mStorageList = new ArrayList<SMPLValue<SMPLObject>>();
	}

	public SMPLVector(final int size) {
		super("vector");
	...
	public boolean isEqualTo(final SMPLObject obj) {
		if (obj instanceof SMPLVector) {
			final SMPLVector obj2 = (SMPLVector) obj;
