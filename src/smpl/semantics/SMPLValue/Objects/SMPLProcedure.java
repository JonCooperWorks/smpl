...
public class SMPLProcedure extends SMPLObject {
	...
	private final ASTExp<?> mBody;
	private final ASTIdent mVArgIdentifier;

	private SMPLEnvironment mClosingEnvironment;

	private final int mFlags;

	public SMPLProcedure(final ASTExp<?> body,
			final ASTIdent varialeArityIdentifier) {
	...
	public SMPLProcedure(final ArrayList<String> params,
			final ASTExp<?> body,
			final ASTIdent excessArityIdentifier) {
